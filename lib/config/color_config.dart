...
class ItemColor {
  ...
  static const Color exceptionalPotentialText =
      Color(0xFFE51E1B); // 익셉셔널 잠재능력 텍스트
  static const Color exceptionalIconBorder = Color(0xFF992200); // 익셉셔널 아이콘 테두리
  static const Color exceptionalIconBackground =
      Color(0xFFFF5500); // 익셉셔널 아이콘 배경
  static const Color exceptionalIconTextShadow =
      Color(0xFFDD2200); // 익셉셔널 아이콘 텍스트 그림자
