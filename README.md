...
애플리케이션에서 제공되는 정보는 NEXON OPEN API에서 제공되는 메이플스토리 게임 데이터를 기반으로 제작되었습니다.</br>
2024년 3월 20일부터 인게임 실시간 데이터를 제공합니다. (평균 15분의 대기시간이 있습니다.)</br>
과거의 데이터는 2023년 12월 21일 데이터부터 조회할 수 있으며, 캐릭터의 정보는 매일 오전 1시를 기준으로 전일 데이터가 저장됩니다.</br>
...
※ 본 애플리케이션은 NEXON의 공식 애플리케이션이 아니며 어떠한 보증도 제공하지 않습니다.</br>
...
※ 본 애플리케이션의 이미지 정보가 부족한 경우, 메인 아이콘 이미지로 대체될 수 있습니다.</br>
