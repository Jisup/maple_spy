...
class ItemColor {
  ...
  static const Color equipmentActiveBackground = Color(0xFFcacaca); // 장착 활성화 칸 배경
  static const Color equipmentDeactiveBackground = Color(0xFFacacac); // 장착 비활성화 칸 배경
  static const Color equipmentImpossibleBackground = Color(0xFFd6adad); // 장착 불가능 칸 배경
  ...
  static const Color rarePotentialDetailBorder = Color(0xFF0099ff); // 레어 디테일 테두리
  static const Color epicPotentialDetailBorder = Color(0xFF7700cc); // 에픽 디테일 테두리
  static const Color uniquePotentialDetailBorder = Color(0xFFffaa00); // 유니크 디테일 테두리
  static const Color legendaryPotentialDetailBorder = Color(0xFF00cc99); // 레전드리 디테일 테두리
  ...
  static const Color legendaryPotientialText = Color(0xFFccff00); // 레전드리 잠재능력 텍스트
