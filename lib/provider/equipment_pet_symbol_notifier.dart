...
final asyncEquipmentPetSymbolProvider = AutoDisposeAsyncNotifierProvider<EquipmentPetSymbolNotifier, MainEquipmentPetSymbol>(EquipmentPetSymbolNotifier.new);

final equipmentSelectSymbolTabProvider = StateProvider((_) => 'ARC');

class EquipmentPetSymbolNotifier extends AutoDisposeAsyncNotifier<MainEquipmentPetSymbol> {
